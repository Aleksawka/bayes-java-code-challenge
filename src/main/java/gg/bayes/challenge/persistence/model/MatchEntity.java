...
public class MatchEntity {
    ...
    public void addLog(CombatLogEntryEntity logEntry) {
        combatLogEntries.add(logEntry);
        logEntry.setMatch(this);
    }

    public void removeLog(CombatLogEntryEntity logEntry) {
        combatLogEntries.remove(logEntry);
        logEntry.setMatch(null);
    }
}