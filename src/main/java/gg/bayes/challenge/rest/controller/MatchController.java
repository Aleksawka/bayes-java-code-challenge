...
import gg.bayes.challenge.service.ChallengeService;
...
public class MatchController {
    ...
    @Autowired
    public MatchController(ChallengeService service) {
    ...
    public ResponseEntity<Long> ingestCombatLog(@RequestBody @NotBlank String combatLog) {
        return ResponseEntity.ok(service.saveMatchLog(combatLog));
    }
    ...
    public ResponseEntity<List<HeroItem>> getHeroItems(
        ...
        return ResponseEntity.ok(service.getHeroItems(matchId, heroName));
    }
    ...
    public ResponseEntity<List<HeroSpells>> getHeroSpells(
        ...
        return ResponseEntity.ok(service.getHeroSpells(matchId, heroName));
    }
    ...
    public ResponseEntity<List<HeroDamage>> getHeroDamages(
        ...
        return ResponseEntity.ok(service.getHeroDamages(matchId, heroName));
    }
}
